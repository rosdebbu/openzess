    ...
    <div className="flex-1 p-10 overflow-y-auto w-full custom-scrollbar">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
           <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="p-6 bg-white dark:bg-surface border border-neutral-200 dark:border-border rounded-2xl shadow-sm hover:border-brand transition-colors cursor-pointer group">
             ...
             <button className="text-brand text-sm font-semibold hover:underline">Read Guide &rarr;</button>
           </motion.div>
           <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="p-6 bg-white dark:bg-surface border border-neutral-200 dark:border-border rounded-2xl shadow-sm hover:border-brand transition-colors cursor-pointer group">
             ...
             <button className="text-brand text-sm font-semibold hover:underline">View API &rarr;</button>
           </motion.div>
        </div>
      </div>
    </div>
