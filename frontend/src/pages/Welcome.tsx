                ...
                <div className="bg-black/40 backdrop-blur-3xl border border-white/10 rounded-3xl p-8 shadow-2xl relative overflow-hidden group hover:border-brand/30 transition-colors duration-500">
                    ...
                    <div className="space-y-6 relative z-10">
                        ...
                        <motion.button 
                            ...
                            className="w-full relative overflow-hidden bg-white text-black font-bold py-4 rounded-xl flex items-center justify-center gap-2 mt-4 shadow-[0_0_30px_rgba(255,255,255,0.1)] disabled:opacity-50 disabled:cursor-not-allowed group"
                        >
                            <span className="absolute inset-0 w-full h-full bg-gradient-to-r from-brand to-purple-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                            {isConnecting ? (
